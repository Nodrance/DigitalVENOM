...
Character.Settings.DIR="Characters/InjectionCube"
Character.Settings.Animations={
	"Idle":[],
}
"""
if self.StateFrame%48 in [26,27,28]:
	...
	self.Sprite=self.Sprites["idle_1"]
"""
#Character.Reset=SCharacter.__init__
#Character.ExtraFunctions.Reset=SCharacter.__init__#types.MethodType(SCharacter.__init__,Character)
#Character.Reset=SCharacter.Reset
#Character.ViperZero=types.MethodType(SCharacter.ViperZero,Character)
#Character.HitFlip=types.MethodType(SCharacter.HitFlip,Character)
#Character.Frame=types.MethodType(SCharacter.Frame,Character)
#Character.Idle=types.MethodType(SCharacter.Idle,Character)
Character.Jump=types.MethodType(SCharacter.Jump,Character)
Character.HitStun=types.MethodType(SCharacter.HitStun,Character)
Character.BlockStun=types.MethodType(SCharacter.BlockStun,Character)
Character.Walk=types.MethodType(SCharacter.Walk,Character)
Character.BackWalk=types.MethodType(SCharacter.BackWalk,Character)
Character.Jab=types.MethodType(SCharacter.Jab,Character)
Character.Strong=types.MethodType(SCharacter.Strong,Character)
Character.Fierce=types.MethodType(SCharacter.Fierce,Character)
Character.Short=types.MethodType(SCharacter.Short,Character)
Character.Forward=types.MethodType(SCharacter.Forward,Character)
Character.Roundhouse=types.MethodType(SCharacter.Roundhouse,Character)
Character.AirDash=types.MethodType(SCharacter.AirDash,Character)
Character.Block=types.MethodType(SCharacter.Block,Character)